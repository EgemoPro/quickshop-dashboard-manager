...
const defaultPositions: DashboardCardPosition[] = [
  ...
  { id: DASHBOARD_CARDS.USER_PROFILE, order: 1, column: 0 },
  { id: DASHBOARD_CARDS.SALES_CHART, order: 2, column: 0 },
  { id: DASHBOARD_CARDS.PRODUCT_PERFORMANCE, order: 3, column: 0 },
  { id: DASHBOARD_CARDS.RECENT_MESSAGES, order: 0, column: 1 },
  { id: DASHBOARD_CARDS.LOW_STOCK, order: 1, column: 1 },
  { id: DASHBOARD_CARDS.RECENT_ORDERS, order: 2, column: 1 },
